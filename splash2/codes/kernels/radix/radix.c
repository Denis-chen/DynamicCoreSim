...
struct global_memory {
   ...
   long (lock_Index);                    /* for fetch and add to get ID */
   long (rank_lock);                     /* for fetch and add to get ID */
/*   long (section_lock);*/  /* key locks */
   long (barrier_rank);                   /* for ranking process */
   long (barrier_key);                    /* for key sorting process */
   double *ranktime;
   double *sorttime;
   double *totaltime;
   long final;
